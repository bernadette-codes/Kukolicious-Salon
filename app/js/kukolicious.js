...
function ThumbnailSlider(a){
    ...
    var mb = function(b){
        ...
        Ab = function(){
            ...
            if(!a.c)b = b.replace("<","^");
            o.a.addRule(c,b,0);
            o.a.addRule(c.replace("prev","next"),
                b.replace("<",">").replace("^","v").replace("left","right"),0)
        },
        E,N,A,B,C,rb,L = {},w = {},z;
    ...
    var Cb = function(){
        ...
        M = null,j,x=0,b,c=[],g=0,R,Wb,S=0,fb=0,tb,y=0,W=1,ab,ib,d,h,k,lb,u=0,bb,cb,sb,
        Lb = function(b){
            if(!b.zimg){
                b.zimg = 1;
        ...
        O = function(p,k){
            ...
            if(!k)Fb(p,j,d);
                ...
                if(j=="auto")if(d=="auto"){
                    ...
                    var o=(window.innerHeight||l.documentElement.clientHeight)*F(d);c[g]=o+"px";
                    c[e]=i/h*o+"px";
        ...
        G = function(d,i,l,o){
            var g=x||5,r=0;
            if(a.f==3&&i)if(l)var f=Math.ceil(g/2),m=d-f,n=d+f+1;
            else {
                m=d-g;n=d+1
            } else {
                f=g;
    ...
    pb.prototype = {
        ...
        b: function(){
            ...
            if(a.k){
                ...
                for(var h=a.l%c[e],d=0;d<h;d++)b.appendChild(c[d]);f=1
            }f&&this.c()
        },
        d: function(d,c){
    ...
    var X = function(){
        ...
        Ob = function(c){
            var a=0;function b(){
                if(a)return;
                a=1;p(c,4)}if(l[t])l[t]("DOMContentLoaded",b,false);
    ...
    return {
        ...
        init: function(e){!M&&X();
            ...
            if(a.f==3){
                i(-c[b][d]+(j[k]-c[b][h])/2,1);gb();J(b,0)
            } else { i(-c[b][d]+j[h],4);n(b,4)
            }
        } // end init
    } // end return
} // end ThumbnailSlider
